...
TEST(config_parse_address_registration_time) {
        /* Positive finite durations are taken as-is. */
        ...
        /* An empty assignment restores the default. */
        test_config_parse_address_registration_time_one(
                        ADDRESS_REGISTRATION_TIME_INITIAL_RETRANSMISSION,
        ...
        /* Unparsable, zero and infinite durations are rejected, leaving the previous value in place. */
